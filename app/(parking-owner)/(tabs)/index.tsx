...
<View style={styles.earningsSummary}>
  ...
  <View style={styles.earningsRow}>
    ...
    <View style={styles.earningsItem}>
      <Text style={styles.earningsLabel}>Service Fees</Text>
      <Text style={styles.earningsValue}>Rs {Math.round(stats.todayEarnings * 0.1).toLocaleString()}</Text>
    </View>
  </View>
</View>
            ...
            <View style={styles.metricLeft}>
              ...
              <View style={styles.metricInfo}>
                ...
                <Text style={styles.metricSubtitle}>
                  {getOccupancyRate()}% of slots currently filled
                </Text>
              </View>
            </View>
