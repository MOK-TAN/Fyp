...
//       setLocationError('Please select location on the map');
//       isValid = false;
//     } else {
//       setLocationError('');
//     }
...
//     console.log(`Attempting to insert ${slotsData.length} slots...`); // For debugging

//     // 3. Insert slots with better error handling
//     const { error: slotsError } = await supabase
//       .from('parking_slots')
//       .insert(slotsData);

//     if (slotsError) {
//       console.error('Slots insert error details:', slotsError);
...
//         `But slots could not be generated automatically.\n\n` +
//         `Error: ${slotsError.message}\n\n` +
//         `You can add slots manually later from the facility management screen.`,
//         [{ text: 'OK', onPress: () => router.back() }]
//       );
//       setIsSubmitting(false);
//       return;
...
//     // Success - both facility and slots created
//     Alert.alert(
//       'Success!',
//       `${name.trim()} has been created with ${totalSlots} slots.`,
//       [{ text: 'OK', onPress: () => router.back() }]
...
//         {/* Location Map Picker - Collapsible */}
//         <View style={styles.fieldGroup}>
//           <TouchableOpacity
...
//                 <TouchableOpacity
//                   style={[styles.mapButton, { backgroundColor: '#22C55E' }]}
