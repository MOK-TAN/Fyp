...
const SignUp = () => {
  ...
  const handleSignUp = async () => {
    ...
    try {
      ...
      // 1b. Block duplicate sign-ups.
      // When "Confirm email" is ON, Supabase does NOT throw for an existing
      // email (to prevent email enumeration) — instead it returns a user with
      // an EMPTY identities array. Detect that and stop here.
      if (
        data.user &&
    ...
    >
      ...
      >
        ...
        <TouchableOpacity
          ...
          style={{ marginBottom: 8, paddingHorizontal: 24 }}
        >
